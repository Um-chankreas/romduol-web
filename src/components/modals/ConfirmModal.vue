<template>
  ...
  >
    <div class="w-full max-w-sm rounded-[28px] bg-[#f8fafd] dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 p-6 sm:p-7 shadow-2xl transition-all text-left">
